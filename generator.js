...
let btnS04 = document.getElementById("button-s04-goals");
let outputS04 = document.getElementById("result-s04-goals");
...
btnS04.addEventListener('click', () => {
	if (numbersArray.length == 0) {
		outputS04.innerText = "No more random numbers";
		return;
	}
	let Solution = getRandomNumber(0, numbersArray.length-1);
	let randomNumber= numbersArray[Solution];
	numbersArray.slice(Solution, 1);
	outputS04.innerText = randomNumber;
});